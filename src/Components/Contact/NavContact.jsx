...
const NavContact = () => {
    ...
    <div className="container px-6  mx-auto">
        <div className="text-center ">
            <p className="font-semibold text-2xl lg:text-5xl md:text-4xl  text-black ">Contact <span className='text-red-500'>Us</span></p>
        </div>

        <img className="object-cover w-full h-72 mt-10 rounded-lg lg:h-[700px]" src="https://images.pexels.com/photos/7163372/pexels-photo-7163372.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2" alt=""/>
...
<div className="grid grid-cols-1 max-w-7xl mb-28 mx-auto gap-12 mt-10 lg:grid-cols-3 sm:grid-cols-2 ">
        ...
        <div>
            <h1 className='text-6xl text-black  font-semibold text-center'>Our <span className='text-red-500'>Location</span></h1>
